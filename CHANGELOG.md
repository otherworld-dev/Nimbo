...
- With more than one account, the flyout names the account it is showing, with its
  server, on a line of its own above the buttons, and clicking it lists the accounts
  to switch to. In Compact width the name used to be cut down to a few letters (#14).
