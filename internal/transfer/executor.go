...
// It only adds the owner-write bit: setting a flat 0644 took the search bit off
// every folder on Unix, so the delete it prepares failed with permission
// denied and left folders nobody could open.
